...
def run_training_from_args(args, pairs_train_iterator, pairs_test_iterator, tensors, glider_mat, glider_map, output):
    ...
    if args.checkpoint is None:
        ...
        model = ModelInteraction(embedding, contact, use_cuda, use_W = use_W, pool_size=pool_width, do_pool=do_pool, do_sigmoid=sigmoid, use_glider=args.use_glider, glider_map=glider_map, glider_mat=glider_mat, glider_param = args.glider_param)
